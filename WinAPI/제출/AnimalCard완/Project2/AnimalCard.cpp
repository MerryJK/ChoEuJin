...
AnimalCard::AnimalCard(int x, int y, int cardNum):m_iCardXPos(x), m_iCardYPos(y), m_iCardCode(cardNum)
{
	...
	{
	case 101:
		m_strAnimalName = L"강아지";
		break;
	case 102:
		m_strAnimalName = L"호랑이";
		break;
	case 103:
		m_strAnimalName = L"오리";
		break;
	case 104:
		m_strAnimalName = L"코끼리";
		break;
	case 105:
		m_strAnimalName = L"소";
		break;
	case 106:
		...
		break;
	case 107:
		m_strAnimalName = L"고양이";
		break;
	case 108:
		m_strAnimalName = L"원숭이";
		break;
	case 109:
		m_strAnimalName = L"개구리";
		break;
	case 110:
		m_strAnimalName = L"닭";
		return;
...
void AnimalCard::CheckClicked(HWND hWnd, int x, int y)
{
	...
	{
		m_IsBack = false;
		MessageBox(hWnd, m_strAnimalName, L"MessageBox", MB_OK);
